...
<div class="container">
    ...
    <form method="get" class="form-inline float-right">
        ...
        <div class="input-group">
            ...
            <button class="btn btn-primary" type="submit" name="btn-cari"><i class="fa fa-search" title="Cari"></i></button>
        </div>
    </form>
</div>
<br>
<form method="GET" action="">
    <input type="hidden" name="page" value="notulen">
    <button class="btn btn-secondary" type="submit" title="Reset">Reset</button>
</form>
<br>
<div class="btn-group">
    <a href="?page=notulen&action=export" class="btn btn-success me-3" title='Cetak Lengkap'>Cetak Excel Lengkap</a>
    <a href="?page=notulen&action=export_singkat" class="btn btn-success" title='Cetak Lengkap'>Cetak Excel Singkat</a>
</div>    
<br>
<br>
